...
class Command(BaseCommand):
    help = 'Popula la base de datos con datos de prueba para PythonAnywhere (sifcol$inv_manaudi)'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=3,
            help='Numero de empresas a crear (default: 3)',
        )

    def handle(self, *args, **options):
        self.stdout.write('=' * 60)
        self.stdout.write(self.style.WARNING('POBLACION DE DATOS PARA PYTHONANYWHERE'))
        self.stdout.write('Base de datos: sifcol$inv_manaudi')
        self.stdout.write('=' * 60)
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f'\n[ERROR] Error durante la poblacion: {str(e)}'))
            import traceback
    ...
    def crear_empresas_y_sucursales(self, num_empresas=3):
        ...
        empresas_data = [
            ...
            },
            {
                ...
                'direccion': 'Av. Ordonez Lasso, Cuenca',
                'telefono': '072831999',
                'email': 'contacto@distnacional.ec',
                'sucursales': [
                    {'nombre': 'Centro Distribucion', 'abreviatura': 'CDI', 'tipo': 'bodega'},
    ...
    def crear_categorias_y_productos(self, empresas):
        ...
        categorias_base = [
            ...
            },
            {
                ...
                'nombre': 'OFICINA',
                'subcategorias': [
                    {'codigo': 'PAP', 'nombre': 'PAPELERIA', 'clases': [
